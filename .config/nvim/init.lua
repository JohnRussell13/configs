...
vim.keymap.set('n', '<leader>r', function()
  ...
  vim.cmd 'terminal'
  vim.cmd 'startinsert'
end, { desc = '[R]un terminal in horizontal split and enter insert mode' })
-- Neotree
  ...
  { -- Adds git related signs to the gutter, as well as utilities for managing changes
    ...
    opts = {
      ...
      on_attach = function(bufnr)
        ...
        map('n', '<leader>hS', gitsigns.stage_buffer, { desc = 'Git [H]unk Stage [B]uffer' })
        map('n', '<leader>hR', gitsigns.reset_buffer, { desc = 'Git [H]unk Reset [B]uffer' })
        map('n', '<leader>hp', gitsigns.preview_hunk, { desc = 'Git [H]unk [P]review' })
        map('n', '<leader>hi', gitsigns.preview_hunk_inline, { desc = 'Git [H]unk Preview Inline' })

        map('n', '<leader>hb', function()
          gitsigns.blame_line { full = true }
        end, { desc = 'Git [B]lame Line (full)' })

        map('n', '<leader>hd', gitsigns.diffthis, { desc = 'Git [D]iff This File' })

        map('n', '<leader>hD', function()
          gitsigns.diffthis '~'
        end, { desc = 'Git Diff This File Against [W]orktree' })

        map('n', '<leader>hQ', function()
          gitsigns.setqflist 'all'
        end, { desc = 'Git Set Quickfix List [A]ll' })
